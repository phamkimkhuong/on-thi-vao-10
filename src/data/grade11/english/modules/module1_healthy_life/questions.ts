...
const pronunciationRows: Row[] = [
  {
    ...
    translation: {
      content: 'Trong câu hỏi trung tính “Do you exercise every morning?”, trợ động từ “do” nhiều khả năng nhất được phát âm ở dạng:',
      options: [
        'A. weak form (dạng nhược âm /də/)',
        'B. strong form',
        'C. past form',
        'D. contracted negative form'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-pron-weak',
    translation: {
      content: 'Trợ động từ nào nhiều khả năng không nhận trọng âm (nhược âm) nhất trong câu “Can Mai join the fitness class?”',
      options: [
        'A. Mai',
        'B. can (trợ động từ can phát âm nhược /kən/)',
        'C. join',
        'D. class'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-pron-weak',
    translation: {
      content: 'Trong câu “Have they finished the health survey?”, trợ động từ “have” thông thường mang:',
      options: [
        'A. trọng âm tương phản (contrastive stress)',
        'B. trọng âm chính của câu',
        'C. a weak form (dạng nhược âm /həv/ hoặc /əv/)',
        'D. ý nghĩa phủ định'
      ]
    }
  },
  {
    ...
    translation: {
      content: 'A: “Could you walk to school today?” B: “I am not sure.” Trong câu hỏi trung tính của A, từ “could” thường:',
      options: [
        'A. bị lược bỏ',
        'B. nhận trọng âm mạnh',
        'C. chuyển thành can',
        'D. weak and unstressed (nhược âm và không mang trọng âm)'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-pron-weak',
    translation: {
      content: 'Phát biểu nào mô tả đúng nhất về từ “was” trong câu hỏi “Was he tired after the race?”',
      options: [
        'A. It is normally weak because it only forms the question. (Nó thường ở dạng nhược âm vì chỉ đóng vai trò tạo câu hỏi)',
        'B. Nó bắt buộc phải mang dạng cường âm vì ở quá khứ',
        'C. Nó bị câm trước một đại từ',
        'D. Nó là động từ chính mang trọng âm từ vựng'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-pron-weak',
    translation: {
      content: 'Chọn ngữ cảnh mà trong đó từ “has” nhiều khả năng ở dạng nhược âm nhất.',
      options: [
        'A. “Who has?”',
        'B. “Yes, she has.”',
        'C. “Has Lan taken her medicine?” (Đứng đầu câu hỏi nghi vấn không nhấn mạnh -> nhược âm /həz/)',
        'D. “She HAS taken it, despite your doubt.”'
      ]
    }
  },
  {
    ...
    translation: {
      content: 'Trong câu trả lời ngắn “Yes, I do.”, từ “do” thông thường được phát âm ở dạng:',
      options: [
        'A. weak form',
        'B. strong form (dạng cường âm /duː/ ở cuối câu trả lời ngắn)',
        'C. infinitive marker',
        'D. contracted form'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Can you swim?” B: “Yes, I can.” Lần xuất hiện nào của từ “can” thông thường ở dạng cường âm?',
      options: [
        'A. Không lần nào cả',
        'B. Cả hai lần đều bằng nhau',
        'C. Lần ở trong câu hỏi của A',
        'D. The one in B’s short answer (Lần ở trong câu trả lời ngắn của B: /kæn/)'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-pron-strong',
    translation: {
      content: 'Câu nào thể hiện rõ nhất yêu cầu dạng cường âm của trợ động từ in hoa?',
      options: [
        'A. HAVE you eaten?',
        'B. She HAS finished, although you said she had not. (HAS mang dạng cường âm /hæz/ để nhấn mạnh đối lập với "had not")',
        'C. CAN he run?',
        'D. WERE they late?'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-pron-strong',
    translation: {
      content: 'Trong câu “I said I could finish, and I COULD,” từ “could” ở cuối mang dạng cường âm chủ yếu vì nó:',
      options: [
        'A. đứng sau một đại từ',
        'B. ám chỉ tương lai',
        'C. is contrasted and stands without a following main verb (được nhấn mạnh tương phản và đứng một mình không có động từ chính theo sau)',
        'D. bắt đầu một mệnh đề phụ thuộc'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-pron-strong',
    translation: {
      content: 'Người nói nhấn mạnh từ “DO” trong câu “I DO eat vegetables” để:',
      options: [
        'A. correct or strongly confirm the statement (xác nhận mạnh mẽ hoặc đính chính khẳng định)',
        'B. hỏi một câu hỏi trung tính',
        'C. đánh dấu thì quá khứ',
        'D. rút ngắn câu'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'Cặp nào phản ánh tự nhiên nhất một dạng nhược âm theo sau bởi một dạng cường âm?',
      options: [
        'A. “She runs” / “She walks”',
        'B. “Healthy food” / “fresh food”',
        'C. “Do you?” / “Do they?”',
        'D. “Have you finished?” / “Yes, I have.” (Câu hỏi: /həv/ nhược âm -> Câu trả lời ngắn: /hæv/ cường âm)'
      ]
    }
  }
];
...
const vocabularyRows: Row[] = [
  {
    ...
    translation: {
      content: 'Một chế độ ăn uống ______ cung cấp cho cơ thể các chất dinh dưỡng khác nhau với lượng phù hợp.',
      options: [
        'A. balanced (cân bằng / balanced diet)',
        'B. repeated',
        'C. narrow',
        'D. sleepy'
      ]
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-meaning',
    translation: {
      content: 'Hệ ______ của cơ thể giúp bảo vệ cơ thể khỏi nhiều bệnh nhiễm trùng.',
      options: [
        'A. living',
        'B. immune (hệ miễn dịch / immune system)',
        'C. social',
        'D. breathing'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-meaning',
    translation: {
      content: 'Khám sức khỏe định kỳ có thể giúp các bác sĩ ______ bệnh ở giai đoạn sớm.',
      options: [
        'A. decorate',
        'B. replace',
        'C. detect (phát hiện / detect a disease)',
        'D. perform'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Tuổi thọ trung bình nghĩa là gì?” B: “Đó là số năm trung bình mà một người dự kiến sẽ ______.”',
      options: [
        'A. exercise',
        'B. study',
        'C. travel',
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-meaning',
    translation: {
      content: 'Trái cây tươi chứa các vitamin và các ______ khác mà cơ thể cần.',
      options: [
        'A. nutrients (chất dinh dưỡng)',
        'B. symptoms',
        'C. treatments',
        'D. routines'
      ]
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-meaning',
    translation: {
      content: 'Sốt và ho kéo dài có thể là các ______ của một bệnh nhiễm trùng.',
      options: [
        'A. habits',
        'B. symptoms (triệu chứng / symptoms of an infection)',
        'C. ingredients',
        'D. lifestyles'
      ]
    }
  },
  {
    ...
    translation: {
      content: 'Đi bộ 30 phút mỗi ngày có thể ______ hệ miễn dịch của bạn.',
      options: [
        'A. boost (tăng cường / boost your immune system)',
        'B. rise',
        'C. enlarge',
        'D. grow up'
      ]
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-collocation',
    translation: {
      content: 'Để cải thiện sức khỏe, Nam đang cố gắng ______ thói quen thức khuya.',
      options: [
        'A. build',
        'B. break (từ bỏ / break the habit)',
        'C. catch',
        'D. hold'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-collocation',
    translation: {
      content: 'Các chuyên gia khuyên nên tập thể dục ______ thay vì tập nặng một lần mỗi tháng.',
      options: [
        'A. balanced',
        'B. stable',
        'C. regular (thường xuyên / regular exercise)',
        'D. repeated'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Tại sao Linh lại vắng mặt?” B: “Bạn ấy đang ______ một cơn cảm lạnh nặng.”',
      options: [
        'A. caring for',
        'B. looking at',
        'C. depending on',
        'D. suffering from (bị mắc/chịu đựng / suffering from a cold)'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-collocation',
    translation: {
      content: 'Vệ sinh và chăm sóc y tế tốt hơn đã làm tăng ______ sống trung bình ở nhiều quốc gia.',
      options: [
        'A. expectancy (tuổi thọ / life expectancy)',
        'B. expectation',
        'C. extension',
        'D. experience'
      ]
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-vocab-collocation',
    translation: {
      content: 'Cụm từ “sedentary lifestyle” (lối sống ít vận động) gần nghĩa nhất với một lối sống có:',
      options: [
        'A. chế độ ăn uống đa dạng',
        'B. very little physical activity (rất ít hoạt động thể chất)',
        'C. đi du lịch thường xuyên',
        'D. điều trị y tế định kỳ'
      ]
    }
  }
];
...
const grammarRows: Row[] = [
  {
    ...
    translation: {
      content: 'Ông tớ ______ hút thuốc cách đây 20 năm.',
      options: [
        'A. stopped (Thì quá khứ đơn với dấu hiệu twenty years ago: stopped)',
        'B. has stopped',
        'C. stops',
        'D. has been stopping'
      ]
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-time',
    translation: {
      content: 'Lan đã theo đuổi thói quen tập thể dục này ______ ba tháng.',
      options: [
        'A. since',
        'B. for (Khoảng thời gian dùng "for": for three months)',
        'C. ago',
        'D. last'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-time',
    translation: {
      content: 'Trường học ______ một buổi hội thảo sức khỏe vào thứ Sáu tuần trước.',
      options: [
        'A. has organised',
        'B. organises',
        'C. organised (Dấu hiệu quá khứ đơn last Friday: organised)',
        'D. has been organising'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Cậu đã uống thuốc ______ chưa?” B: “Tớ chưa.”',
      options: [
        'A. yesterday',
        'B. last night',
        'C. ago',
        'D. yet (Thì hiện tại hoàn thành câu hỏi dùng "yet")'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-time',
    translation: {
      content: 'Cô ấy ______ một người ăn chay kể từ khi 16 tuổi.',
      options: [
        'A. has been (Mệnh đề since + S + V(past) đi với Hiện tại hoàn thành: has been)',
        'B. was',
        'C. is',
        'D. became'
      ]
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-time',
    translation: {
      content: 'Chúng tớ ______ thầy giáo thể dục mới vào tháng 9 năm 2025.',
      options: [
        'A. have met',
        'B. met (Mốc thời gian quá khứ xác định: met)',
        'C. meet',
        'D. have known'
      ]
    }
  },
  {
    ...
    translation: {
      content: 'Tớ không thể tham gia chạy bộ vì tớ ______ mắt cá chân.',
      options: [
        'A. injured',
        'B. injure',
        'C. have injured (Hành động vừa xảy ra để lại hậu quả hiện tại: have injured)',
        'D. was injuring'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Minh đâu rồi?” B: “Cậu ấy ______ đến hiệu thuốc. Cậu ấy sẽ quay lại sớm thôi.”',
      options: [
        'A. went',
        'B. goes',
        'C. was going',
        'D. has gone (Đi chưa về chia has gone)'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-context',
    translation: {
      content: 'Đây là lần đầu tiên tớ ______ một cuộc chạy đua 10 km.',
      options: [
        'A. have completed (Cấu trúc This is the first time + S + have/has V3/ed)',
        'B. completed',
        'C. complete',
        'D. had completed'
      ]
  ...
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-context',
    translation: {
      content: 'Khi mẹ tớ học đại học, bà ______ cho đội bóng rổ của trường.',
      options: [
        'A. has played',
        'B. played (Hành động đã kết thúc hoàn toàn trong quá khứ: played)',
        'C. has been playing',
        'D. plays'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-context',
    translation: {
      content: 'Chọn câu phân biệt đúng giữa Thì quá khứ đơn và Thì hiện tại hoàn thành:',
      options: [
        'A. I have visited the doctor yesterday. (Sai vì yesterday dùng quá khứ đơn)',
        'B. I visited the doctor since Monday. (Sai vì since dùng hiện tại hoàn thành)',
        'C. I have not eaten fast food for two months. (Đúng: hiện tại hoàn thành kết hợp với for + khoảng thời gian)',
        'D. I did not drink soft drinks so far. (Sai vì so far dùng hiện tại hoàn thành)'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-grammar-context',
    translation: {
      content: 'Phòng khám cộng đồng đã mở cửa vào năm 2020 và nó ______ các đợt kiểm tra sức khỏe miễn phí từ đó đến nay.',
      options: [
        'A. offered',
        'B. offers yesterday',
        'C. was offering',
        'D. has offered (Kéo dài từ quá khứ đến hiện tại với ever since: has offered)'
      ]
    }
  }
];
...
const readingRows: Row[] = [
  {
    ...
    translation: {
      ...
      options: [
        'A. Small, realistic habits are often easier to maintain than extreme plans. (Các thói quen nhỏ, thực tế thường dễ duy trì hơn là các kế hoạch quá sức.)',
        'B. Học sinh nên tập thể dục 1 tiếng mỗi ngày.',
        'C. Lịch là công cụ tốt nhất để cải thiện sức khỏe.',
        'D. Thức ăn ngọt là nguyên nhân chính gây thất bại thói quen.'
      ]
    }
  },
  {
    ...
    stimulus: passage1,
    translation: {
      content: 'Theo đoạn văn, tại sao các kế hoạch sức khỏe quá sức thường thất bại/biến mất?',
      options: [
        'A. Chúng không tạo ra bất kỳ kết quả nào.',
        'B. They require too much attention and energy. (Chúng đòi hỏi quá nhiều sự chú ý và năng lượng.)',
        'C. Học sinh không thích uống nước.',
        'D. Chúng được thiết kế bởi giáo viên.'
      ]
    }
  },
  {
    ...
    stimulus: passage1,
    translation: {
      content: 'Hành động nào được gợi ý như một cách đơn giản để đo lường sự tiến bộ?',
      options: [
        'A. Mua dụng cụ thể thao',
        'B. Tham gia một cuộc thi',
        'C. Marking a calendar (Đánh dấu vào lịch)',
        'D. Cân bản thân mỗi giờ'
      ]
    }
  },
  {
    ...
    stimulus: passage1,
    translation: {
      content: 'Phát biểu nào sau đây là đúng theo đoạn văn?',
      options: [
        'A. Bỏ lỡ một ngày làm hỏng hoàn toàn thói quen.',
        'B. Các thói quen khó luôn là hiệu quả nhất.',
        'C. Học sinh không bao giờ nên thay đổi thói quen.',
        'D. A routine should be adjusted to a person’s real situation. (Một thói quen nên được điều chỉnh phù hợp với hoàn cảnh thực tế của từng người.)'
      ]
    }
  },
  {
    ...
    stimulus: passage2,
    translation: {
      content: 'Nhan đề nào tóm tắt tốt nhất cho đoạn văn thứ hai?',
      options: [
        'A. Why sleep is an essential and active part of health (Tại sao giấc ngủ là một phần thiết yếu và chủ động của sức khỏe)',
        'B. Cách học xuyên đêm',
        'C. Tại sao tất cả học sinh cần thuốc',
        'D. Lịch sử của các thiết bị kỹ thuật số'
      ]
    }
  },
  {
    ...
    stimulus: passage2,
    translation: {
      content: 'Yếu tố nào KHÔNG được đề cập là làm giảm giấc ngủ của học sinh?',
      options: [
        'A. Bài tập về nhà',
        'B. Mạng xã hội',
        'C. Lịch học sớm',
        'D. Gardening (Làm vườn)'
      ]
    }
  },
  {
    ...
    stimulus: passage2,
    translation: {
      content: 'Cụm từ “defeats its own purpose” (phản tác dụng) trong đoạn 2 có nghĩa là một thói quen cứng nhắc có thể:',
      options: [
        'A. làm giấc ngủ đắt đỏ hơn',
        'B. create anxiety instead of helping rest (tạo ra sự lo âu thay vì giúp nghỉ ngơi)',
        'C. khiến mọi người tập thể dục nhiều hơn',
        'D. thay thế việc điều trị y tế'
      ]
    }
  },
  {
    ...
    stimulus: passage2,
    translation: {
      content: 'Có thể suy ra điều gì từ đoạn văn thứ 2?',
      options: [
        'A. Daily choices may help, but continuing problems require professional advice. (Lựa chọn hằng ngày có thể giúp ích, nhưng các vấn đề kéo dài cần có lời khuyên chuyên môn.)',
        'B. Mọi người nên theo đuổi chính xác cùng một thói quen đi ngủ.',
        'C. Giấc ngủ ít quan trọng hơn việc ôn thi.',
        'D. Chất caffeine ngừng ảnh hưởng đến cơ thể ngay lập tức.'
      ]
    }
  },
  {
    ...
    stimulus: passage3,
    translation: {
      content: 'Tại sao phòng khám lại giúp thành lập nhóm làm vườn?',
      options: [
        'A. Để bán rau cho bệnh nhân',
        'B. Để thay thế mọi điều trị y tế',
        'C. To offer social contact and light activity (Để mang lại sự giao lưu xã hội và hoạt động nhẹ nhàng)',
        'D. Để đào tạo bệnh nhân thành người làm vườn chuyên nghiệp'
      ]
    }
  },
  {
    ...
    stimulus: passage3,
    translation: {
      content: 'Từ “They” trong đoạn cuối cùng thay thế cho:',
      options: [
        'A. các bệnh viện',
        'B. các thói quen',
        'C. các chuyên gia',
        'D. community activities (các hoạt động cộng đồng)'
      ]
    }
  },
  {
    ...
    stimulus: passage3,
    translation: {
      content: 'Tại sao tác giả lại thận trọng khi nói làm vườn gây ra mọi sự cải thiện?',
      options: [
        'A. Other factors, including motivation and social contact, may have contributed. (Các yếu tố khác, bao gồm động lực và giao lưu xã hội, có thể đã đóng góp vào.)',
        'B. Khu vườn không trồng được loại rau nào.',
        'C. Tất cả người tham gia đều ngừng đi bộ.',
        'D. Bác sĩ từ chối quan sát chương trình.'
      ]
    }
  },
  {
    ...
    stimulus: passage3,
    translation: {
      content: 'Kết luận nào về sự hỗ trợ sức khỏe cộng đồng được ủng hộ tốt nhất bởi đoạn văn 3?',
      options: [
        'A. Thuốc là không cần thiết cho người cao tuổi.',
        'B. Well-designed community activities can complement professional health care. (Các hoạt động cộng đồng được thiết kế tốt có thể bổ sung cho việc chăm sóc y tế chuyên nghiệp.)',
        'C. Làm vườn là hình thức tập thể dục duy nhất có ích.',
        'D. Mỗi bệnh nhân nên nhận cùng một hoạt động.'
      ]
    }
  }
];
...
const writingRows: Row[] = [
  {
    ...
    translation: {
      content: 'Chọn thứ tự tốt nhất: (a) Kết quả là cô ấy thấy nhiều năng lượng hơn trong lớp. (b) Lan bắt đầu đi bộ đến trường cách đây 3 tháng. (c) Giờ đây cô ấy đi bộ khoảng 20 phút mỗi sáng.',
      options: ['A. b-c-a', 'B. a-b-c', 'C. c-a-b', 'D. b-a-c']
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-order',
    translation: {
      content: 'Chọn câu tốt nhất để bắt đầu một đoạn văn nói về thói quen ngủ lành mạnh.',
      options: [
        'A. Ví dụ, điện thoại phát ra ánh sáng.',
        'B. Several simple habits can improve the quality of our sleep. (Một vài thói quen đơn giản có thể cải thiện chất lượng giấc ngủ của chúng ta.)',
        'C. Do đó, tớ đã tắt nó đi.',
        'D. Điều này cũng giúp ích.'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-order',
    translation: {
      content: 'Chọn từ nối logic nhất: “Minh thường cảm thấy mệt mỏi vào buổi sáng. ______, cậu ấy quyết định đi ngủ sớm hơn.”',
      options: [
        'A. Tuy nhiên (However)',
        'B. Ví dụ (For example)',
        'C. Therefore (Do đó / Vì vậy)',
        'D. Trong khi đó (Meanwhile)'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: (a) Trước tiên, hãy chuẩn bị một kế hoạch tuần thực tế. (b) Cuối cùng, hãy xem lại và thực hiện các điều chỉnh nhỏ. (c) Tiếp theo, ghi lại xem liệu cậu đã hoàn thành từng hành động hay chưa. Chọn thứ tự đúng nhất.',
      options: ['A. c-a-b', 'B. b-c-a', 'C. a-b-c', 'D. a-c-b']
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-order',
    translation: {
      content: 'Câu nào KHÔNG bổ trợ cho chủ đề “Hoạt động thể chất thường xuyên mang lại lợi ích cho học sinh”?',
      options: [
        'A. Some schools were built many years ago. (Một số trường học được xây dựng từ nhiều năm trước - Không liên quan)',
        'B. Tập thể dục giúp cải thiện sự tập trung.',
        'C. Thể thao đồng đội phát triển tinh thần hợp tác.',
        'D. Vận động giúp giảm thời gian ngồi nhiều.'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-order',
    translation: {
      content: 'Chọn câu kết luận tốt nhất cho một đoạn văn mô tả một số thay đổi nhỏ về sức khỏe.',
      options: [
        'A. Một sự thay đổi là uống nhiều nước hơn.',
        'B. Together, these manageable changes have made my routine healthier. (Cùng nhau, những thay đổi dễ thực hiện này đã làm cho thói quen của tớ lành mạnh hơn.)',
        'C. Bình nước của tớ màu xanh.',
        'D. Thứ Hai tuần trước trời mưa.'
      ]
    }
  },
  {
    ...
    translation: {
      content: 'Chọn câu gần nghĩa nhất: “Tớ đã bắt đầu tập yoga cách đây 2 năm.”',
      options: [
        'A. Tớ đã tập yoga trong 2 năm rồi dừng lại.',
        'B. Sai ngữ pháp.',
        'C. I have done yoga for two years. (Tớ đã tập yoga được 2 năm - Thì hiện tại hoàn thành)',
        'D. Sai ngữ pháp.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Lần cuối cùng Mai ăn đồ ăn nhanh là vào tháng 5.” Câu nào đồng nghĩa?',
      options: [
        'A. Mai đã ăn đồ ăn nhanh từ tháng 5.',
        'B. Mai chỉ ăn đồ ăn nhanh vào tháng 5.',
        'C. Mai chưa bao giờ ăn đồ ăn nhanh.',
        'D. Mai has not eaten fast food since May. (Mai đã không ăn đồ ăn nhanh kể từ tháng 5.)'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-transform',
    translation: {
      content: 'Chọn câu chủ đề tốt nhất cho các chi tiết bổ trợ về nước, giấc ngủ và việc tập thể dục.',
      options: [
        'A. Daily routines strongly influence our health. (Các thói quen hằng ngày ảnh hưởng mạnh mẽ đến sức khỏe của chúng ta.)',
        'B. Nước được bán ở nhiều cửa hàng.',
        'C. Hôm qua tớ đã mua đôi giày mới.',
        'D. Trường tớ có 3 tầng.'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-transform',
    translation: {
      content: 'Chọn câu kết hợp tốt nhất: “Nam có một chế độ ăn cân bằng. Cậu ấy vẫn cần tập thể dục thường xuyên.”',
      options: [
        'A. Vì Nam có chế độ ăn cân bằng nên cậu ấy không bao giờ tập thể dục.',
        'B. Although Nam has a balanced diet, he still needs regular exercise. (Mặc dù Nam có một chế độ ăn cân bằng, cậu ấy vẫn cần tập thể dục thường xuyên.)',
        'C. Nam có chế độ ăn cân bằng nên tập thể dục có hại.',
        'D. Nam cần tập thể dục trừ khi cậu ấy có chế độ ăn cân bằng.'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-transform',
    translation: {
      content: 'Bản sửa đổi nào rõ ràng và súc tích nhất?',
      options: [
        'A. Tập thể dục tốt vì tập thể dục có các lợi ích tốt. (Dư thừa)',
        'B. Tập thể dục, thứ mà là tập thể dục, có lợi. (Lặp từ)',
        'C. Regular exercise supports both physical and mental health. (Tập thể dục thường xuyên hỗ trợ cả sức khỏe thể chất lẫn tinh thần.)',
        'D. Dài dòng lủng củng.'
      ]
    }
  },
  {
    ...
    subTypeId: 'eng11-u1-write-transform',
    translation: {
      content: 'Chọn câu kết thúc tốt nhất cho một email rủ bạn tham gia buổi đi bộ cuối tuần.',
      options: [
        'A. Đi bộ đã tồn tại từ lâu.',
        'B. Giày của tớ đắt tiền.',
        'C. Sức khỏe là một chủ đề rộng.',
        'D. Let me know if you are free to join me on Saturday morning. (Hãy cho tớ biết nếu cậu rảnh để tham gia cùng tớ vào sáng thứ Bảy nhé.)'
      ]
    }
  }
];
...
const communicationRows: Row[] = [
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Tớ thường cảm thấy mệt mỏi sau khi thức khuya.” B: “______”',
      options: [
        'A. You should try going to bed earlier. (Cậu nên thử đi ngủ sớm hơn xem sao.)',
        'B. Tớ đã thức khuya năm ngoái.',
        'C. Đó không phải sách của tớ.',
        'D. Đừng đề cập đến sức khỏe.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Tại sao cậu không đi bộ một đoạn ngắn sau bữa tối nhỉ?” B: “______”',
      options: [
        'A. Bữa tối thật ngắn.',
        'B. That sounds like a good idea. (Nghe có vẻ là một ý kiến hay đấy.)',
        'C. Tớ không biết tại sao cậu lại đi bộ.',
        'D. Không, cậu đã không làm.'
      ]
    }
  },
  {
    ...
    translation: {
      content: 'Lời khuyên nào là lịch sự nhất dành cho một bạn cùng lớp đang bị căng thẳng?',
      options: [
        'A. Thôi phàn nàn đi.',
        'B. Cậu đang làm sai mọi thứ.',
        'C. You could take a short break and talk to someone you trust. (Cậu có thể nghỉ ngơi một chút và trò chuyện với ai đó mà cậu tin tưởng.)',
        'D. Cậu phải nghe lời tớ.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Tớ muốn ăn uống lành mạnh hơn, nhưng tớ không biết bắt đầu từ đâu.” B: “______”',
      options: [
        'A. Sức khỏe đã bắt đầu từ hôm qua.',
        'B. Tớ biết cửa hàng ở đâu.',
        'C. Cậu đã ăn lúc giữa trưa.',
        'D. How about adding one portion of vegetables to dinner?” (Hay là thêm một phần rau vào bữa tối xem sao?)'
      ]
    }
  },
  {
    ...
    representationType: 'text',
    translation: {
      content: 'Một người bạn đưa ra lời khuyên sức khỏe hữu ích cho bạn. Phản hồi nào là phù hợp nhất?',
      options: [
        'A. Thanks. I’ll give it a try. (Cảm ơn cậu. Tớ sẽ thử xem sao.)',
        'B. Cậu không có quyền nói.',
        'C. Câu hỏi đó màu xanh.',
        'D. Tớ đã không khuyên.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Nếu tớ là cậu, tớ sẽ nói chuyện với y tế nhà trường.” B: “______”',
      options: [
        'A. Y tá ở trường.',
        'B. Thank you. I think I will. (Cảm ơn cậu. Tớ nghĩ tớ sẽ làm vậy.)',
        'C. Cậu đã là tớ ngày hôm qua.',
        'D. Nói là một danh từ.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Hôm nay cậu cảm thấy khá hơn chưa?” B: “______”',
      options: [
        'A. Yes, much better, thanks. (Ừ, tớ thấy khá hơn nhiều rồi, cảm ơn cậu.)',
        'B. Sức khỏe rất quan trọng.',
        'C. Tớ cảm thấy ngày hôm qua.',
        'D. Câu hỏi dài.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Cậu có muốn tham gia buổi chạy sáng của nhóm tớ không?” B: “______ Tớ có cuộc hẹn lúc đó mất rồi.”',
      options: [
        'A. Điều đó chứng minh nó.',
        'B. I’d love to, but I can’t. (Tớ rất muốn, nhưng tớ không thể.)',
        'C. Cậu phải chạy.',
        'D. Buổi sáng là trước giữa trưa.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Tớ vừa hoàn thành chặng chạy 5 km đầu tiên của mình!” B: “______”',
      options: [
        'A. Đừng bận tâm khoảng cách.',
        'B. Tớ không đồng ý với việc chạy.',
        'C. Congratulations! That is a great achievement. (Xin chúc mừng! Đó là một thành tích tuyệt vời.)',
        'D. Cậu đã hoàn thành nó ngày mai.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Cậu có thể chỉ cho tớ cách sử dụng máy tập này an toàn được không?” B: “______”',
      options: [
        'A. Máy móc làm bằng kim loại.',
        'B. Đáng lẽ cậu phải biết rồi chứ.',
        'C. Tớ đã dùng nó tháng trước.',
        'D. Certainly. Start by adjusting the seat.” (Tất nhiên rồi. Bắt đầu bằng việc điều chỉnh ghế ngồi nhé.)'
      ]
    }
  },
  {
    ...
    representationType: 'text',
    translation: {
      content: 'Câu nào thể hiện sự quan tâm một cách thích hợp?',
      options: [
        'A. You look unwell. Would you like me to call the nurse? (Trông cậu không được khỏe. Cậu có muốn tớ gọi y tá không?)',
        'B. Cậu luôn gây rắc rối.',
        'C. Bệnh tật là danh từ tiếng Anh.',
        'D. Đừng trả lời tớ.'
      ]
    }
  },
  {
    ...
    representationType: 'dialogue',
    translation: {
      content: 'A: “Bác sĩ bảo tớ cần nghỉ ngơi trong vài ngày.” B: “______”',
      options: [
        'A. Bác sĩ nghỉ ngơi mỗi ngày.',
        'B. I hope you recover soon. (Tớ hy vọng cậu sớm bình phục.)',
        'C. Vài nghĩa là chính xác 3.',
        'D. Cậu nên lờ nó đi.'
      ]
    }
  }
