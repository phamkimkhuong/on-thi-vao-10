...
export const englishTopics: Topic[] = [
  { id: 'eng-t1', subjectId: 'english', name: 'Ngữ âm', slug: 'ngu-am', orderIndex: 1 },
  { id: 'eng-t2', subjectId: 'english', name: 'Từ vựng & Ngữ pháp', slug: 'tu-vung-va-ngu-phap', orderIndex: 2 },
  { id: 'eng-t3', subjectId: 'english', name: 'Đọc hiểu', slug: 'doc-hieu', orderIndex: 3 },
  { id: 'eng-t4', subjectId: 'english', name: 'Viết & Biến đổi câu', slug: 'viet-va-bien-doi-cau', orderIndex: 4 }
];
