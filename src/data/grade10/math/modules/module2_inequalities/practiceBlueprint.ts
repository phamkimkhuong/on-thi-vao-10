...
export const g10MathModule2PracticeBlueprints: QuestionTypePracticeBlueprint[] = [{
  ...
  subTypes: [
    { id: 'math10-qt3-st1', name: 'Miền nghiệm của hệ bất phương trình', example: 'Vẽ các đường biên, chọn nửa mặt phẳng và tìm giao các miền.', recognitionSigns: ['Đề yêu cầu kiểm tra điểm, biểu diễn miền nghiệm hoặc tìm các đỉnh.', 'Mỗi bất phương trình tạo một nửa mặt phẳng có kể hoặc không kể đường biên.'], targetQuestionCount: 12 },
