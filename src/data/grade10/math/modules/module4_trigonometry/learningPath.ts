...
export const g10MathModule4Outcomes: LearningOutcome[] = [
  { id: 'MATH10-M4-O01', topicId: 'math10-t4', title: 'Giá trị lượng giác của góc', description: 'Xác định dấu, giá trị và các hệ thức lượng giác cơ bản của góc từ 0° đến 180°.', scope: 'core', orderIndex: 1, questionTypeIds: [], prerequisiteOutcomeIds: [], misconceptionIds: ['MATH10-M4-M01'], evidenceTypes: ['calculation', 'explanation'], estimatedMinutes: 80, isCritical: true },
