...
export const g10MathModule7Outcomes: LearningOutcome[] = [
  { id: 'MATH10-M7-O01', topicId: 'math10-t7', title: 'Mô tả và biểu diễn mẫu số liệu', description: 'Đọc bảng, biểu đồ; xác định số gần đúng, sai số và các đặc trưng xu thế trung tâm.', scope: 'core', orderIndex: 1, questionTypeIds: ['math10-qt11'], prerequisiteOutcomeIds: [], misconceptionIds: ['MATH10-M7-M01'], evidenceTypes: ['data', 'calculation'], estimatedMinutes: 110, isCritical: true },
  { id: 'MATH10-M7-O02', topicId: 'math10-t7', title: 'Độ phân tán và giá trị ngoại lệ', description: 'Tính, so sánh khoảng biến thiên, khoảng tứ phân vị, phương sai, độ lệch chuẩn và nhận diện ngoại lệ.', scope: 'core', orderIndex: 2, questionTypeIds: ['math10-qt12'], prerequisiteOutcomeIds: ['MATH10-M7-O01'], misconceptionIds: ['MATH10-M7-M02'], evidenceTypes: ['data', 'calculation', 'explanation'], estimatedMinutes: 130, isCritical: true },
  { id: 'MATH10-M7-O03', topicId: 'math10-t9', title: 'Xác suất theo mô hình cổ điển', description: 'Mô tả không gian mẫu hữu hạn đồng khả năng, đếm biến cố và tính xác suất.', scope: 'core', orderIndex: 3, questionTypeIds: ['math10-qt13'], prerequisiteOutcomeIds: ['MATH10-M6-O01'], misconceptionIds: ['MATH10-M7-M03'], evidenceTypes: ['calculation', 'application'], estimatedMinutes: 120, isCritical: true }
];
