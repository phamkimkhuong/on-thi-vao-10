...
export const g10MathModule1Outcomes: LearningOutcome[] = [
  { id: 'MATH10-M1-O01', topicId: 'math10-t1', title: 'Mệnh đề và phép toán logic', description: 'Nhận biết mệnh đề, phủ định, mệnh đề kéo theo, tương đương và xác định tính đúng sai trong tình huống phù hợp.', scope: 'core', orderIndex: 1, questionTypeIds: ['math10-qt17'], prerequisiteOutcomeIds: [], misconceptionIds: ['MATH10-M1-M01'], evidenceTypes: ['recognition', 'explanation'], estimatedMinutes: 60, isCritical: true },
