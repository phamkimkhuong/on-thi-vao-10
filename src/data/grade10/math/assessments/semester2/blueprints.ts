...
export const mathMidterm2Blueprint: AssessmentBlueprint = {
  ...
  duration: 90,
  totalPoints: 10,
  scopeTopicIds: ['math10-t6', 'math10-t7', 'math10-t9'],
  topicWeights: { 'math10-t6': 0.4, 'math10-t7': 0.3, 'math10-t9': 0.3 },
...
export const mathFinal2Blueprint: AssessmentBlueprint = {
  ...
  duration: 90,
  totalPoints: 10,
  scopeTopicIds: ['math10-t3', 'math10-t6', 'math10-t7', 'math10-t8', 'math10-t9'],
  topicWeights: { 'math10-t3': 0.1, 'math10-t6': 0.2, 'math10-t7': 0.15, 'math10-t8': 0.35, 'math10-t9': 0.2 },
  outcomeIds: [
