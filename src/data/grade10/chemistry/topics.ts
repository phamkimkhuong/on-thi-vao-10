...
export const g10ChemistryTopics: Topic[] = [
  { id: 'chem10-t0', subjectId: 'chemistry', name: 'Nhập môn Hóa học & Cầu nối', slug: 'nhap-mon-cau-noi', orderIndex: 1, tier: 1 },
  { id: 'chem10-t1', subjectId: 'chemistry', name: 'Cấu tạo nguyên tử', slug: 'cau-tao-nguyen-tu', orderIndex: 2, tier: 1 },
  { id: 'chem10-t2', subjectId: 'chemistry', name: 'Bảng tuần hoàn & Định luật tuần hoàn', slug: 'bang-tuan-hoan', orderIndex: 3, tier: 1 },
  { id: 'chem10-t3', subjectId: 'chemistry', name: 'Liên kết hóa học', slug: 'lien-ket-hoa-hoc', orderIndex: 4, tier: 1 },
