...
export const g10ChemistryOutcomes: LearningOutcome[] = [
  ...
  { id: 'chem10-rate-catalyst', topicId: 'chem10-t6', orderIndex: 4, scope: 'core', title: 'Xúc tác và thiết kế thí nghiệm', description: 'Giải thích năng lượng hoạt hóa và kiểm soát biến.', questionTypeIds: ['chem10-qt29'], prerequisiteOutcomeIds: ['chem10-rate-factors','chem10-intro-inquiry'], misconceptionIds: ['chem10-mis-catalyst-enthalpy'], evidenceTypes: ['explanation','experiment','data'], estimatedMinutes: 28, isCritical: true },
  { id: 'chem10-halogen-trends', topicId: 'chem10-t7', orderIndex: 1, scope: 'core', title: 'Vị trí và xu hướng Halogen', description: 'Liên hệ cấu hình ns²np⁵ với xu hướng nhóm.', questionTypeIds: ['chem10-qt30'], prerequisiteOutcomeIds: ['chem10-periodic-character','chem10-atom-configuration'], misconceptionIds: [], evidenceTypes: ['explanation','data'], estimatedMinutes: 26, isCritical: true },
  { id: 'chem10-halogen-oxidizing', topicId: 'chem10-t7', orderIndex: 2, scope: 'core', title: 'Tính oxi hóa và phản ứng thế', description: 'Dự đoán phản ứng giữa halogen và halide.', questionTypeIds: ['chem10-qt31'], prerequisiteOutcomeIds: ['chem10-halogen-trends','chem10-redox-agents'], misconceptionIds: ['chem10-mis-halogen-displacement'], evidenceTypes: ['explanation','application'], estimatedMinutes: 28, isCritical: true },
  ...
  { id: 'chem10-halogen-hydrogen', topicId: 'chem10-t7', orderIndex: 4, scope: 'core', title: 'Hydrogen halide và acid', description: 'Giải thích HF khác biệt, xu hướng acid và tính khử.', questionTypeIds: ['chem10-qt33'], prerequisiteOutcomeIds: ['chem10-halogen-trends','chem10-bond-intermolecular'], misconceptionIds: ['chem10-mis-hf-acid'], evidenceTypes: ['explanation','application'], estimatedMinutes: 28, isCritical: true },
  { id: 'chem10-halogen-identification', topicId: 'chem10-t7', orderIndex: 5, scope: 'core', title: 'Nhận biết ion halide', description: 'Dùng ion bạc, màu kết tủa và ứng dụng an toàn.', questionTypeIds: ['chem10-qt34'], prerequisiteOutcomeIds: ['chem10-halogen-hydrogen'], misconceptionIds: [], evidenceTypes: ['experiment','data','application'], estimatedMinutes: 28 },
  { id: 'chem10-synthesis-structure', topicId: 'chem10-t8', orderIndex: 1, scope: 'core', title: 'Kết nối cấu tạo và tính chất', description: 'Suy luận xuyên suốt từ cấu hình electron đến vị trí, liên kết và tính chất.', questionTypeIds: ['chem10-qt35'], prerequisiteOutcomeIds: ['chem10-periodic-compounds','chem10-bond-intermolecular'], misconceptionIds: [], evidenceTypes: ['explanation','application'], estimatedMinutes: 35, isCritical: true },
