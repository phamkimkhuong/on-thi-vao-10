...
const unitSpecs: EnglishSkillUnitSpec[] = [
  {
    ...
    readingQuestions: [
      { prompt: 'What is the passage mainly about?', options: ['Moving to a larger apartment', 'A family creating a fair system for chores', 'Children refusing to do housework', 'Ways to clean an apartment quickly'], answer: 'B', difficulty: 'easy', explanation: 'Every paragraph describes why and how the family changed its chore system.' },
      { prompt: 'Why did the family hold a meeting?', options: ['Mrs Tran wanted to buy new plants', 'The children needed more pocket money', 'The old arrangement caused tiredness and arguments', 'Mr Tran wanted to stop shopping'], answer: 'C', difficulty: 'medium', explanation: 'The passage directly links the meeting to Mrs Tran’s tiredness and weekend arguments.' },
      { prompt: 'The word “rotate” is closest in meaning to __________.', options: ['change regularly', 'finish immediately', 'become easier', 'remain fixed'], answer: 'A', difficulty: 'medium', explanation: 'The jobs change every month instead of remaining with one person.' },
      { prompt: 'In the final sentence, “it” refers to __________.', options: ['help', 'one person', 'housework', 'the family'], answer: 'C', difficulty: 'hard', explanation: 'The singular pronoun points back to housework: housework is a shared duty.' },
      { prompt: 'What can be inferred about the new system?', options: ['It makes the apartment perfect every day', 'It teaches responsibility as well as reducing conflict', 'It gives the children no free time', 'It depends on Mrs Tran checking every task'], answer: 'B', difficulty: 'hard', explanation: 'The family is calmer and the children become more responsible, although the home is not perfect.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'What are Mai and Nam mainly doing?', options: ['Preparing for a basketball match', 'Planning how to share weekend tasks', 'Choosing food for their grandparents', 'Discussing their younger sister’s school'], answer: 'B', difficulty: 'easy', explanation: 'The whole conversation is about assigning weekend chores.' },
      { prompt: 'Why can Nam not clean on Friday immediately after school?', options: ['He visits his grandparents', 'He has basketball practice', 'He must cook lunch', 'He helps his sister'], answer: 'B', difficulty: 'medium', explanation: 'Nam has practice until seven.' },
      { prompt: 'What will Mai do on Saturday morning?', options: ['Buy vegetables', 'Clean the floor', 'Prepare lunch', 'Write a shopping list'], answer: 'C', difficulty: 'medium', explanation: 'Nam buys vegetables while Mai prepares lunch.' },
      { prompt: 'Why do they put the plan on the fridge?', options: ['To show it to their coach', 'To remember the division and avoid conflict', 'To ask their parents for money', 'To teach their sister to cook'], answer: 'B', difficulty: 'hard', explanation: 'The note makes responsibilities clear and helps prevent arguments.' }
    ],
    writingTasks: [
  ...
  },
  {
    ...
    readingQuestions: [
      { prompt: 'What is the main purpose of the passage?', options: ['To advertise a new school canteen', 'To show how evidence led to practical environmental action', 'To explain why libraries should sell bottles', 'To compare two different schools'], answer: 'B', difficulty: 'easy', explanation: 'The project moves from measurement to targeted action and measurable results.' },
      { prompt: 'What problem was found in empty classrooms?', options: ['Windows were left open', 'Rubbish was not collected', 'Lights and fans were still operating', 'Students borrowed too many bottles'], answer: 'C', difficulty: 'medium', explanation: 'This detail appears in the third sentence.' },
      { prompt: 'The word “deposit” most nearly means __________.', options: ['money temporarily paid and later returned', 'a permanent school tax', 'a discount on electricity', 'the price of library membership'], answer: 'A', difficulty: 'medium', explanation: 'A borrowing deposit is held to encourage return of the bottle.' },
      { prompt: 'What does “it” in “it showed why data matters” refer to?', options: ['the canteen', 'the environmental problem', 'the project', 'the library'], answer: 'C', difficulty: 'hard', explanation: 'The project showed the value of data.' },
      { prompt: 'Which principle is best supported by the project?', options: ['Awareness alone always changes behaviour', 'Environmental plans work better when goals can be measured', 'Plastic should be completely banned immediately', 'Only students can reduce school waste'], answer: 'B', difficulty: 'hard', explanation: 'The conclusion stresses clear problems, practical actions and measurable results.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'What decision is the class making?', options: ['How to build a wetland', 'Where to go on a class trip', 'Which birds to feed', 'How many teachers need tickets'], answer: 'B', difficulty: 'easy', explanation: 'The teacher compares two destinations for the trip.' },
      { prompt: 'Why is the wetland centre greener in terms of transport?', options: ['It provides free bicycles', 'It is closer and needs only one bus', 'Students can walk there', 'The centre pays for fuel'], answer: 'B', difficulty: 'medium', explanation: 'It is twenty kilometres away and the class can use one bus.' },
      { prompt: 'What activity will students do at the wetland?', options: ['Buy packaged food', 'Feed wild birds', 'Collect wildlife data', 'Ride in two buses'], answer: 'C', difficulty: 'medium', explanation: 'They agree to collect data about birds.' },
      { prompt: 'What broader message does the teacher give?', options: ['Cheap trips are always better', 'Entertainment is the only goal of travel', 'A green visit should avoid harming the destination', 'Students should never visit theme parks'], answer: 'C', difficulty: 'hard', explanation: 'The final sentence explicitly connects green travel with protecting the place.' }
    ],
    writingTasks: [
  ...
  },
  {
    ...
    readingQuestions: [
      { prompt: 'What is the central idea of the passage?', options: ['Only talented singers can organise concerts', 'A concert supported a library and developed different student talents', 'The school replaced music with technology', 'A bookshop organised the whole event'], answer: 'B', difficulty: 'easy', explanation: 'The passage combines the charitable purpose with diverse student contributions.' },
      { prompt: 'What did the shy student do?', options: ['Performed a solo', 'Operated the sound system', 'Designed the concert poster', 'Sold books'], answer: 'C', difficulty: 'medium', explanation: 'The passage directly states that the shy student produced the poster.' },
      { prompt: 'The phrase “match the money” means the bookshop would __________.', options: ['keep the ticket income', 'give an equal additional amount', 'count the money', 'sell tickets at the same price'], answer: 'B', difficulty: 'medium', explanation: 'To match a donation is to contribute the same amount.' },
      { prompt: 'What does “something less visible” refer to?', options: ['new library books', 'ticket sales', 'students’ teamwork and personal growth', 'the sound equipment'], answer: 'C', difficulty: 'hard', explanation: 'The colon introduces listening, problem-solving and purposeful artistic work.' },
      { prompt: 'Which conclusion is best supported?', options: ['Community music projects need professional performers', 'Musical events can include valuable non-performing roles', 'Publicity is more important than performance', 'Schools should charge high ticket prices'], answer: 'B', difficulty: 'hard', explanation: 'Students contributed through design, technology, presentation and publicity as well as performance.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'What problem does Linh first identify?', options: ['The keyboard is broken', 'The final lines are unclear at the current speed', 'The guitarist is absent', 'The concert has been cancelled'], answer: 'B', difficulty: 'easy', explanation: 'She says the song is too fast for clear pronunciation.' },
      { prompt: 'How does the teacher help the band decide?', options: ['She chooses immediately', 'She asks the audience', 'She has them record and compare two versions', 'She removes the second song'], answer: 'C', difficulty: 'medium', explanation: 'The teacher suggests evidence from recordings at both speeds.' },
      { prompt: 'What change is made to the keyboard?', options: ['It plays faster', 'It becomes quieter in the first verse', 'It stops completely', 'It copies the guitar'], answer: 'B', difficulty: 'medium', explanation: 'The keyboard player lowers the volume.' },
      { prompt: 'What lesson does the band learn?', options: ['Every instrument should be equally loud', 'Fast songs always sound better', 'Balance matters more than maximum volume', 'Singers should control the sound system'], answer: 'C', difficulty: 'hard', explanation: 'The final sentence gives this lesson directly.' }
    ],
    writingTasks: [
    ...
    communicationQuestions: [
      ...
      { prompt: 'Choose the most constructive rehearsal feedback.', options: ['That sounded bad.', 'The chorus was clear; could we lower the guitar during the verse?', 'You always play too loudly.', 'I have no comment.'], answer: 'B', difficulty: 'medium', explanation: 'It identifies a strength and gives a specific improvement.' },
      { prompt: 'Which response resolves disagreement through evidence?', options: ['I am the leader, so I decide.', 'Let us record both versions and compare them.', 'Your version is obviously wrong.', 'We should stop rehearsing.'], answer: 'B', difficulty: 'hard', explanation: 'Testing both versions turns opinion into an evidence-based decision.' }
    ]
  },
  {
    unit: 4,
    ...
    readingTitle: 'From giving things to building relationships',
    readingPassage: `A youth group in Minh An village used to organise one-day donation trips. Volunteers arrived with clothes and books, took photographs and left before they had learned much about local needs. Although the gifts were useful, village teachers explained that irregular visits did not solve their biggest problem: many children needed weekly help with reading. The group changed its approach. Instead of planning activities for the community, members first interviewed teachers, parents and students. They then created an online reading club, paired volunteers with small groups of children and scheduled two in-person visits each month. Volunteers received basic training and kept notes so that the next session continued from the previous one. After a term, teachers reported that students read more confidently and attended more regularly. The volunteers also benefited because they learned to listen rather than assume. The project showed that community service is most effective when people work with a community over time, define goals together and measure whether their actions meet real needs.`,
    readingQuestions: [
      { prompt: 'What change is described in the passage?', options: ['A village stopped accepting books', 'A youth group moved from short donations to sustained cooperation', 'Teachers replaced volunteers', 'Children began selling clothes online'], answer: 'B', difficulty: 'easy', explanation: 'The contrast is between one-day donation trips and a continuing reading programme.' },
      { prompt: 'What did teachers identify as the biggest need?', options: ['More photographs', 'Weekly reading support', 'New school uniforms', 'A larger village library'], answer: 'B', difficulty: 'medium', explanation: 'Teachers specifically said many children needed weekly help with reading.' },
      { prompt: 'The word “irregular” is closest in meaning to __________.', options: ['not happening consistently', 'carefully planned', 'extremely expensive', 'professionally managed'], answer: 'A', difficulty: 'medium', explanation: 'The earlier visits were occasional rather than regular.' },
      { prompt: 'Why did volunteers keep notes?', options: ['To advertise the project', 'To calculate travel costs', 'To ensure continuity between sessions', 'To replace teacher reports'], answer: 'C', difficulty: 'hard', explanation: 'Notes allowed each new session to continue from the previous one.' },
      { prompt: 'Which idea would the author most likely support?', options: ['Volunteers always know what communities need', 'Useful service requires consultation and long-term follow-up', 'Donations should never be accepted', 'Online activities are always better than visits'], answer: 'B', difficulty: 'hard', explanation: 'The final sentence emphasises shared goals, time and measurement.' }
    ],
  ...
  },
  {
    ...
    readingQuestions: [
      { prompt: 'What is the passage mainly about?', options: ['Why medicine should be cheaper', 'How user feedback improved an invention', 'How to study engineering', 'Why older adults dislike technology'], answer: 'B', difficulty: 'easy', explanation: 'The product becomes useful through repeated testing with actual users.' },
      { prompt: 'Which was NOT a problem with the first prototype?', options: ['The alarm was quiet', 'The text was small', 'The lid was difficult to open', 'It collected too much personal data'], answer: 'D', difficulty: 'medium', explanation: 'Privacy is discussed as a design choice in the improved version, not an original reported failure.' },
      { prompt: 'The word “prototype” refers to __________.', options: ['an early model used for testing', 'a medical prescription', 'a group of users', 'a privacy law'], answer: 'A', difficulty: 'medium', explanation: 'The original prototype is the early version tested and revised.' },
      { prompt: 'Why was only necessary data collected?', options: ['The device had no memory', 'The designers wanted to respect privacy', 'Users refused to press a button', 'The screen was too large'], answer: 'B', difficulty: 'hard', explanation: 'The final sentence links responsible invention with privacy.' },
      { prompt: 'What can be inferred from the final version being “less visually impressive”?', options: ['Appearance was prioritised over function', 'Practical accessibility mattered more than a complex look', 'The device stopped working', 'Users preferred the original box'], answer: 'B', difficulty: 'hard', explanation: 'Users trusted the simpler but more accessible design.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'What are the students choosing?', options: ['A history topic', 'A note-taking application', 'A person to interview', 'A lecture to record'], answer: 'B', difficulty: 'easy', explanation: 'The conversation compares two note-taking apps.' },
      { prompt: 'What concern does Lan have about the first app?', options: ['It has no transcript', 'It may record people without permission', 'It cannot recognise dates', 'It is too slow'], answer: 'B', difficulty: 'medium', explanation: 'Lan raises a privacy and consent concern.' },
      { prompt: 'How will the students divide work with the chosen app?', options: ['Both will record audio', 'One writes notes and one checks facts', 'The historian writes everything', 'The app checks all sources automatically'], answer: 'B', difficulty: 'medium', explanation: 'They assign note-taking and fact-checking roles.' },
      { prompt: 'Which values guide the final decision?', options: ['Popularity and appearance', 'Speed only', 'Accuracy, consent and responsibility', 'Price and entertainment'], answer: 'C', difficulty: 'hard', explanation: 'These values are stated at the end.' }
    ],
    writingTasks: [
  ...
  },
  {
    ...
    readingQuestions: [
      { prompt: 'What problem did the club leader notice?', options: ['Students refused to build robots', 'Project roles followed gender stereotypes', 'The club had no presentation equipment', 'Boys and girls worked in separate clubs'], answer: 'B', difficulty: 'easy', explanation: 'Roles were divided informally along gender lines.' },
      { prompt: 'What did the rotation system require?', options: ['Only experienced students could code', 'Every member tried each major project role', 'Girls presented every project', 'Boys attended extra meetings'], answer: 'B', difficulty: 'medium', explanation: 'Planning, construction, coding, testing and presentation rotated.' },
      { prompt: 'The word “barriers” most nearly means __________.', options: ['prizes', 'obstacles', 'machines', 'instructions'], answer: 'B', difficulty: 'medium', explanation: 'Barriers are conditions that prevent people from participating or progressing.' },
      { prompt: 'Why did work initially become slower?', options: ['The robots were larger', 'Students were learning unfamiliar roles', 'The leader cancelled workshops', 'Presentations were removed'], answer: 'B', difficulty: 'hard', explanation: 'Rotation created a temporary learning period.' },
      { prompt: 'Which statement best captures the author’s view?', options: ['Equality means pretending differences never exist', 'Opportunity requires access, support and skill development', 'Every task must always be completed equally', 'Natural ability should determine roles permanently'], answer: 'B', difficulty: 'hard', explanation: 'The ending defines equality through removing barriers and creating genuine chances.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'What document are Hoa and Duc revising?', options: ['A project report', 'A recruitment advertisement', 'A workshop timetable', 'A product manual'], answer: 'B', difficulty: 'easy', explanation: 'They review an advertisement for a team leader.' },
      { prompt: 'Why does Hoa object to “strong young man”?', options: ['The job has no pressure', 'It may exclude qualified people for irrelevant reasons', 'The enterprise hires only adults', 'Boxes are never moved'], answer: 'B', difficulty: 'medium', explanation: 'Gender and age are replaced by actual job requirements.' },
      { prompt: 'What replaces the word “young”?', options: ['A requirement about evening availability', 'A higher salary', 'A coding qualification', 'A driving licence'], answer: 'A', difficulty: 'medium', explanation: 'Availability for two evening events is the genuine need.' },
      { prompt: 'What principle guides the revision?', options: ['Describe a preferred personality', 'List relevant tasks and qualifications', 'Make the advertisement shorter at any cost', 'Avoid mentioning responsibilities'], answer: 'B', difficulty: 'hard', explanation: 'The final version focuses on work and evidence-based criteria.' }
    ],
    writingTasks: [
  ...
  },
  {
    ...
    readingQuestions: [
      { prompt: 'What is the passage mainly about?', options: ['Competition between relief organisations', 'How coordinated local and international support aided recovery', 'Why storms affect only coastal businesses', 'A new international database company'], answer: 'B', difficulty: 'easy', explanation: 'The passage explains roles, coordination problems and lessons from joint relief.' },
      { prompt: 'What role did the youth network perform?', options: ['It produced water filters', 'It mapped villages and translated requests', 'It rebuilt every road', 'It trained doctors'], answer: 'B', difficulty: 'medium', explanation: 'Those tasks are stated in the second sentence.' },
      { prompt: 'The word “duplication” refers to __________.', options: ['the same aid being delivered more than once', 'villages becoming larger', 'reports being translated', 'businesses reducing prices'], answer: 'A', difficulty: 'medium', explanation: 'Different systems caused repeated deliveries.' },
      { prompt: 'Why were local businesses involved after roads reopened?', options: ['To replace community representatives', 'To support supply and the local economy', 'To end international cooperation', 'To control the database'], answer: 'B', difficulty: 'hard', explanation: 'Local purchasing supported recovery without weakening economic activity.' },
      { prompt: 'Which factor is presented as essential for effective cooperation?', options: ['Outside organisations making all decisions', 'One identical solution for every village', 'Transparent information and community participation', 'Avoiding daily communication'], answer: 'C', difficulty: 'hard', explanation: 'The final sentence states these principles.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'What will the students present?', options: ['A tourism advertisement', 'A local recycling project', 'A language lesson', 'A sports competition'], answer: 'B', difficulty: 'easy', explanation: 'The forum presentation concerns their recycling project.' },
      { prompt: 'What evidence will one student use?', options: ['A long video', 'A simple chart', 'A list of abbreviations', 'A school uniform'], answer: 'B', difficulty: 'medium', explanation: 'The second student will show a chart.' },
      { prompt: 'Why should local abbreviations be avoided?', options: ['They are grammatically incorrect', 'International participants may not understand them', 'The presentation must be shorter than one minute', 'Charts cannot contain letters'], answer: 'B', difficulty: 'medium', explanation: 'The audience comes from different countries.' },
      { prompt: 'How does the teacher define the purpose of exchange?', options: ['Winning a competition', 'Copying one solution exactly', 'Sharing, listening and adapting ideas', 'Promoting one school only'], answer: 'C', difficulty: 'hard', explanation: 'The final two sentences contrast competition with mutual learning.' }
    ],
    writingTasks: [
  ...
  },
  {
    ...
    readingQuestions: [
      { prompt: 'What is the main message?', options: ['Tablets should replace teachers', 'Digital tools require purposeful learning routines', 'Students should use as many sources as possible', 'Slides are better than explanations'], answer: 'B', difficulty: 'easy', explanation: 'Improvement came from structured research and discussion, not the devices alone.' },
      { prompt: 'What did students do before researching after the change?', options: ['Closed every application', 'Wrote a question and predicted needed evidence', 'Designed slides first', 'Asked teachers for one website'], answer: 'B', difficulty: 'medium', explanation: 'This was the first new research routine.' },
      { prompt: 'The word “evaluating” most nearly means __________.', options: ['copying', 'judging quality and relevance', 'downloading', 'translating'], answer: 'B', difficulty: 'medium', explanation: 'Students needed to judge sources rather than copy them.' },
      { prompt: 'Why were screen-free periods included?', options: ['The tablets had weak batteries', 'Groups needed to explain ideas directly', 'Teachers disliked technology', 'Students had completed every task'], answer: 'B', difficulty: 'hard', explanation: 'Closed-screen discussion required active explanation.' },
      { prompt: 'What can be inferred about the number of sources?', options: ['More sources always produce better work', 'Careful selection can be better than collecting many weak sources', 'Students stopped researching', 'Only printed sources were allowed'], answer: 'B', difficulty: 'hard', explanation: 'Students used fewer sources but produced clearer reasoning.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'What problem has occurred?', options: ['The presentation topic changed', 'Students overwrote one another’s slide work', 'No student has internet access', 'The deadline was cancelled'], answer: 'B', difficulty: 'easy', explanation: 'Two students edited the same slide and deleted work.' },
      { prompt: 'Where will students first collect ideas?', options: ['In private messages', 'In a shared outline', 'On the final slide', 'In a recorded video'], answer: 'B', difficulty: 'medium', explanation: 'The shared outline makes comments visible.' },
      { prompt: 'Why is the internal deadline early?', options: ['To finish before choosing evidence', 'To leave time for technical problems', 'To prevent language review', 'To avoid rehearsal'], answer: 'B', difficulty: 'medium', explanation: 'The extra day is a buffer for problems.' },
      { prompt: 'Why are project decisions kept in the shared document?', options: ['It uses less electricity', 'Everyone can see and follow them', 'Private messages are illegal', 'Only the leader can edit it'], answer: 'B', difficulty: 'hard', explanation: 'Transparency prevents members from missing decisions.' }
    ],
    writingTasks: [
    ...
    speakingTasks: [
      ...
      { prompt: 'Give a two-minute comparison of online and face-to-face learning with a balanced conclusion.', difficulty: 'hard', model: 'Online study offers pace and access; classroom study offers immediate interaction. A blended model works when each environment is used for the task it supports best.' }
    ],
    communicationQuestions: [
      { prompt: 'A classmate shares an article without an author or date. What should you say?', options: ['Use it because the title is interesting.', 'Could we verify the source before including this claim?', 'Delete the whole project.', 'Sources never matter online.'], answer: 'B', difficulty: 'easy', explanation: 'Verification is appropriate and collaborative.' },
      { prompt: 'Which feedback is most actionable?', options: ['Nice slides.', 'The conclusion is unclear; add one sentence linking the evidence to your claim.', 'I do not like it.', 'Change everything.'], answer: 'B', difficulty: 'medium', explanation: 'It identifies a location, issue and concrete revision.' },
      { prompt: 'Which group rule best protects shared understanding?', options: ['Each person learns only one slide', 'Every member must be able to explain the final argument', 'The designer makes all decisions', 'Private messages replace the shared document'], answer: 'B', difficulty: 'hard', explanation: 'Shared explanation prevents fragmented participation.' }
    ]
  },
  {
    unit: 9,
    ...
    readingTitle: 'Restoring a wetland without oversimplifying the problem',
    readingPassage: `For decades, a wetland near Nam Phu town was treated as unused land. Parts were drained for construction, and pollution reduced the number of fish and birds. A restoration campaign first focused on planting thousands of trees. Scientists supported the enthusiasm but warned that trees alone would not repair the wetland. Some proposed species did not naturally grow there and could consume too much water. The plan was revised after researchers, fishers and residents mapped water flow, native plants, nesting areas and pollution sources. Volunteers removed rubbish and replanted native vegetation, while the town improved wastewater monitoring upstream. A raised walking path allowed visitors to observe wildlife without entering sensitive areas. Two years later, bird diversity had increased and flooding after heavy rain was less severe. Nevertheless, the team continued monitoring water quality because recovery was incomplete. The project demonstrated that ecosystems are networks: effective protection must address habitat, water, species and human activity together rather than rely on one highly visible action.`,
    readingQuestions: [
      { prompt: 'What is the passage mainly about?', options: ['Why all wetlands should become parks', 'A restoration project becoming more evidence-based and comprehensive', 'A campaign that only planted trees', 'How to construct houses near water'], answer: 'B', difficulty: 'easy', explanation: 'The initial simple plan is revised into ecosystem-level restoration.' },
      { prompt: 'Why were some proposed trees unsuitable?', options: ['They were too expensive', 'They were non-native and might use too much water', 'Birds could not see them', 'Residents disliked their colour'], answer: 'B', difficulty: 'medium', explanation: 'Both reasons are stated directly.' },
      { prompt: 'The word “upstream” refers to a location __________.', options: ['toward the source of the water flow', 'under the walking path', 'inside a bird nest', 'far from any river'], answer: 'A', difficulty: 'medium', explanation: 'Pollution upstream travels down into the wetland.' },
      { prompt: 'Why was the walking path raised?', options: ['To increase construction land', 'To let visitors observe without disturbing habitat', 'To stop all flooding', 'To carry wastewater'], answer: 'B', difficulty: 'hard', explanation: 'It separates visitor access from sensitive areas.' },
      { prompt: 'Which lesson does the project support?', options: ['One popular action can solve every ecosystem problem', 'Monitoring is unnecessary after visible improvement', 'Protection must address connected environmental factors', 'Human activity should never be considered'], answer: 'C', difficulty: 'hard', explanation: 'The conclusion defines ecosystems as networks.' }
    ],
    listeningTitle: 'Interpreting an environmental claim',
    listeningScript: `A student sees an advertisement stating that a product is “one hundred percent green” because its package is recyclable. Her teacher asks three questions. First, is recycling available where the product is sold? Second, how much material and energy are used to make the package? Third, what happens to the product itself after use? The student discovers that the package contains mixed materials that most local facilities cannot process. The company also provides no evidence about production emissions. The teacher explains that one positive feature does not prove that an entire product has no environmental impact. The student rewrites her report to say that the package is designed to be recyclable but may not be recycled locally. She also notes what information is missing. This wording is less dramatic than the advertisement, but it is more accurate and helps readers make an informed decision.`,
    listeningQuestions: [
      { prompt: 'What claim is being examined?', options: ['A product is completely green', 'A school has no recycling bins', 'A teacher designed packaging', 'Local facilities use no energy'], answer: 'A', difficulty: 'easy', explanation: 'The advertisement calls the product “one hundred percent green.”' },
      { prompt: 'What problem exists with the package materials?', options: ['They are too heavy to transport', 'Most local facilities cannot process the mixture', 'They contain no label', 'The company uses paper only'], answer: 'B', difficulty: 'medium', explanation: 'Mixed materials limit actual recyclability.' },
      { prompt: 'What production information is missing?', options: ['The package colour', 'Emission evidence', 'The shop address', 'The student’s name'], answer: 'B', difficulty: 'medium', explanation: 'The company provides no evidence about production emissions.' },
      { prompt: 'Why is the revised wording better?', options: ['It is more dramatic', 'It distinguishes design claims from local reality and missing evidence', 'It guarantees the product is harmless', 'It removes every limitation'], answer: 'B', difficulty: 'hard', explanation: 'The revision is precise about what is known and unknown.' }
    ],
    writingTasks: [
      { prompt: 'Write 60–80 words describing one local environmental issue and one possible action.', difficulty: 'easy', minimumWords: 60, model: 'A canal near my neighbourhood often contains plastic bags and food packaging. The waste blocks water flow and creates an unpleasant smell after rain. A useful first action would be a weekly waste count at three locations. The results could help residents identify the largest source before organising clean-up and prevention.' },
      { prompt: 'Write a 90–120-word fact-check of an environmental claim. State evidence and missing information.', difficulty: 'medium', minimumWords: 90, model: 'The claim that this cup is “completely environmentally friendly” is not supported by enough evidence. The cup is made from paper, but the advertisement does not explain whether it has a plastic lining or whether local facilities can recycle it. It also gives no information about energy used in production. A more accurate statement would be that the cup may reduce some plastic use if it is processed correctly. Consumers need disposal instructions and independently verified data before concluding that the whole product is green.' },
      { prompt: 'Write a 120–150-word ecosystem protection proposal with actions, indicators and monitoring.', difficulty: 'hard', minimumWords: 120, model: 'I propose restoring the stream beside our school through a one-year monitoring programme. The first month should establish baseline data on rubbish, water clarity and the number of visible plant and animal species. Students can then remove litter, place labelled bins at major entry points and work with local authorities to investigate wastewater sources. Native plants should be added only after an environmental specialist confirms suitable species. Success indicators will include less rubbish, improved water clarity and a gradual return of biodiversity. Measurements should be repeated monthly and published on a simple dashboard. If one indicator does not improve, the team must investigate the cause rather than continue the same visible activity. This approach connects action with evidence and long-term responsibility.' }
    ],
    speakingTasks: [
      { prompt: 'Speak for one minute explaining why one species or habitat should be protected.', difficulty: 'easy', model: 'Wetlands should be protected because they provide habitat, filter water and reduce flooding. Protecting them benefits wildlife and nearby communities at the same time.' },
      { prompt: 'Role-play questioning a company representative about a “green” product claim.', difficulty: 'medium', model: 'Could you provide evidence about production emissions and explain whether local facilities can recycle the mixed packaging?' },
      { prompt: 'Give a two-minute environmental briefing that separates evidence, uncertainty and recommendation.', difficulty: 'hard', model: 'Our bird count has increased, but two months of data cannot prove full recovery. We recommend continuing habitat restoration while monitoring water quality for a full year.' }
    ],
    communicationQuestions: [
      { prompt: 'Which statement is scientifically cautious?', options: ['This action will save the ecosystem.', 'Early results are encouraging, but longer monitoring is needed.', 'One photograph proves recovery.', 'There are no remaining risks.'], answer: 'B', difficulty: 'easy', explanation: 'It reports evidence without claiming more than the data supports.' },
      { prompt: 'How should missing evidence be reported?', options: ['Hide it to strengthen the message.', 'State clearly what is unknown and what data is needed.', 'Invent a likely number.', 'Reject every possible action.'], answer: 'B', difficulty: 'medium', explanation: 'Transparent uncertainty supports informed decisions.' },
      { prompt: 'Which response best challenges greenwashing?', options: ['The colour is green, so the claim is true.', 'What independently verified evidence supports the whole-life impact claim?', 'All companies lie.', 'Recyclable always means recycled.'], answer: 'B', difficulty: 'hard', explanation: 'It requests relevant, verifiable life-cycle evidence.' }
    ]
  },
  {
    unit: 10,
    ...
    readingQuestions: [
      { prompt: 'What central problem did the reserve face?', options: ['Nobody wanted to visit', 'Tourism income rose while visitor pressure damaged rare plants', 'Local guides refused training', 'The live camera stopped working'], answer: 'B', difficulty: 'easy', explanation: 'The reserve needed to balance benefits with ecological damage.' },
      { prompt: 'Why were signs alone ineffective?', options: ['They used the wrong language', 'Visitors arrived too quickly for rules to be reinforced', 'The plants covered them', 'Businesses removed them'], answer: 'B', difficulty: 'medium', explanation: 'Rangers could not brief the growing number of visitors.' },
      { prompt: 'The word “compacting” means __________.', options: ['pressing soil tightly together', 'adding water to soil', 'photographing flowers', 'marking a trail'], answer: 'A', difficulty: 'medium', explanation: 'Leaving the trail pressed the soil around plants.' },
      { prompt: 'How did longer guided visits help local businesses?', options: ['Tickets became free', 'Tourists spent more on meals and crafts', 'Every visitor stayed at a hotel', 'The reserve removed limits'], answer: 'B', difficulty: 'hard', explanation: 'Visitors made more local purchases instead of stopping briefly.' },
      { prompt: 'Which policy best reflects the passage’s definition of ecotourism?', options: ['Maximise visitors and repair damage later', 'Close every natural area permanently', 'Set evidence-based limits and return benefits to conservation and residents', 'Use nature only as an advertising background'], answer: 'C', difficulty: 'hard', explanation: 'The conclusion combines limits, education, local benefit and monitoring.' }
    ],
    ...
    listeningQuestions: [
      { prompt: 'Why must visitors stay on the raised path?', options: ['The boats are too small', 'Young mangrove roots are fragile', 'Local products are sold there', 'Photography is forbidden'], answer: 'B', difficulty: 'easy', explanation: 'The guide says the roots are easily damaged.' },
      { prompt: 'What should visitors do near nesting birds?', options: ['Use flash', 'Speak loudly', 'Keep voices low', 'Offer food'], answer: 'C', difficulty: 'medium', explanation: 'Low voices and no flash reduce disturbance.' },
      { prompt: 'When should visitors ask permission to take photographs?', options: ['Before photographing people at work', 'Before photographing the path', 'Before photographing their own boat', 'Before photographing bottled water'], answer: 'A', difficulty: 'medium', explanation: 'The guide specifically mentions workers in the craft village.' },
      { prompt: 'Why should monkeys not be fed?', options: ['Food is too expensive', 'It alters behaviour and creates safety risks', 'Monkeys cannot approach boats', 'The tour ends early'], answer: 'B', difficulty: 'hard', explanation: 'Feeding changes natural behaviour and can harm animals and people.' }
    ],
    writingTasks: [
  ...
  detailedSteps: [
    ...
    ...(skill === 'l'
      ? [{
          ...
          explanation: spec.listeningScript
        }]
      : [])
  ],
