...
export const g10BiologyModule0Questions: Question[] = [
  {
  ...
  {
    id: 'bio10-m0-q004', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt9',
    responseType: 'single_choice',
    content: 'Hoạt động nào thể hiện trực tiếp vai trò của sinh học trong bảo vệ môi trường?',
    options: ['A. Dùng vi sinh vật phân hủy dầu tràn', 'B. Tăng công suất động cơ đốt trong', 'C. Khai thác tối đa một loài cá', 'D. Thay toàn bộ rừng tự nhiên bằng khu dân cư'], correctAnswer: 'A',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O01'],
    competency: 'biological_application', cognitiveLevel: 'recognition', estimatedSeconds: 45
  },
  {
  ...
  {
    id: 'bio10-m0-q008', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt10',
    responseType: 'single_choice',
    content: 'Để ghi nhận tập tính kiếm ăn tự nhiên của chim mà không chủ động thay đổi môi trường, phương pháp phù hợp nhất là gì?',
    options: ['A. Quan sát', 'B. Thực nghiệm', 'C. Lai giống', 'D. Giải phẫu'], correctAnswer: 'A',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O03'],
    competency: 'biological_inquiry', cognitiveLevel: 'recognition', estimatedSeconds: 45
  },
  {
    id: 'bio10-m0-q009', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt10',
    responseType: 'single_choice',
    content: 'Muốn kiểm tra cường độ ánh sáng có ảnh hưởng đến tốc độ sinh trưởng của cây non hay không, phương pháp chủ đạo nên dùng là gì?',
    options: ['A. Điều tra ý kiến', 'B. Thực nghiệm có kiểm soát', 'C. Chỉ tra cứu tài liệu', 'D. Quan sát một cây bất kì ngoài tự nhiên'], correctAnswer: 'B',
    difficulty: 'medium', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O03'],
    competency: 'biological_inquiry', cognitiveLevel: 'understanding', estimatedSeconds: 55
  },
  {
  ...
  {
    id: 'bio10-m0-q013', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt11',
    responseType: 'single_choice',
    content: 'Khi kiểm tra tác dụng của một loại thuốc lên sự phát triển của vi khuẩn, nhóm đối chứng phù hợp nhất là nhóm nào?',
    options: ['A. Vi khuẩn được xử lí bằng liều thuốc cao nhất', 'B. Vi khuẩn được nuôi cùng điều kiện nhưng không nhận hoạt chất thuốc', 'C. Một loài vi khuẩn khác nuôi ở nhiệt độ khác', 'D. Vi khuẩn không được cung cấp môi trường dinh dưỡng'], correctAnswer: 'B',
    difficulty: 'medium', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O04'],
    competency: 'biological_inquiry', cognitiveLevel: 'understanding', estimatedSeconds: 65
  },
  {
  ...
  {
    id: 'bio10-m0-q016', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt12',
    responseType: 'single_choice',
    stimulus: {
      id: 'bio10-m0-st016', title: 'Tỉ lệ nảy mầm sau 5 ngày',
      dataTable: {
        caption: 'Tỉ lệ nảy mầm của cùng một giống hạt ở các nhiệt độ khác nhau',
        columns: [{ key: 'temperature', label: 'Nhiệt độ', unit: '°C' }, { key: 'rate', label: 'Tỉ lệ nảy mầm', unit: '%' }],
        rows: [{ temperature: 10, rate: 42 }, { temperature: 20, rate: 78 }, { temperature: 30, rate: 91 }, { temperature: 40, rate: 35 }]
      }
    },
  ...
  {
    id: 'bio10-m0-q017', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt12',
    responseType: 'single_choice',
    content: 'Một thí nghiệm được thực hiện một lần với ba cây và cho kết quả phù hợp giả thuyết. Kết luận nào khoa học nhất?',
    options: ['A. Giả thuyết đã được chứng minh đúng trong mọi trường hợp', 'B. Kết quả bước đầu hỗ trợ giả thuyết nhưng cần tăng cỡ mẫu và lặp lại', 'C. Không cần nhóm đối chứng vì kết quả đã phù hợp', 'D. Có thể suy rộng ngay cho mọi loài cây'], correctAnswer: 'B',
    difficulty: 'medium', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O04'],
    competency: 'biological_inquiry', cognitiveLevel: 'understanding', estimatedSeconds: 65
  },
  {
  ...
  {
    id: 'bio10-m0-q019', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt12',
    responseType: 'single_choice',
    stimulus: {
      id: 'bio10-m0-st019', title: 'Số lá mới hình thành',
      dataTable: {
        caption: 'Ba lần lặp ở nhóm đối chứng và nhóm được bổ sung khoáng',
        columns: [{ key: 'group', label: 'Nhóm' }, { key: 'repeat1', label: 'Lần 1' }, { key: 'repeat2', label: 'Lần 2' }, { key: 'repeat3', label: 'Lần 3' }],
        rows: [{ group: 'Đối chứng', repeat1: 4, repeat2: 5, repeat3: 4 }, { group: 'Bổ sung khoáng', repeat1: 8, repeat2: 9, repeat3: 2 }]
      }
    },
  ...
  {
    id: 'bio10-m0-q020', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt13',
    responseType: 'single_choice',
    content: 'Để so sánh nhanh trình tự DNA của hàng nghìn mẫu và tìm các đoạn tương đồng, công cụ phù hợp nhất thuộc lĩnh vực nào?',
    options: ['A. Tin sinh học', 'B. Giải phẫu học', 'C. Địa chất học', 'D. Cơ học'], correctAnswer: 'A',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O05'],
    competency: 'biological_cognition', cognitiveLevel: 'recognition', estimatedSeconds: 45
  },
  {
    id: 'bio10-m0-q021', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt13',
    responseType: 'single_choice',
    content: 'Muốn quan sát cấu trúc siêu hiển vi bên trong tế bào với độ phân giải cao hơn giới hạn của kính hiển vi quang học, nên chọn công cụ nào?',
    options: ['A. Kính lúp', 'B. Kính hiển vi điện tử truyền qua', 'C. Cân điện tử', 'D. Máy đo pH'], correctAnswer: 'B',
    difficulty: 'medium', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O05'],
    competency: 'biological_cognition', cognitiveLevel: 'understanding', estimatedSeconds: 55
  },
  {
    id: 'bio10-m0-q022', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt13',
    responseType: 'single_choice',
    content: 'Phát biểu nào phân biệt đúng độ phóng đại và độ phân giải của kính hiển vi?',
    options: ['A. Độ phóng đại là khả năng phân biệt hai điểm gần nhau', 'B. Độ phân giải là số lần ảnh lớn hơn vật', 'C. Ảnh lớn hơn chưa chắc rõ chi tiết hơn nếu độ phân giải không tăng', 'D. Hai đại lượng luôn hoàn toàn giống nhau'], correctAnswer: 'C',
    difficulty: 'medium', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O05'],
    competency: 'biological_cognition', cognitiveLevel: 'understanding', estimatedSeconds: 65
  },
  {
  ...
  {
    id: 'bio10-m0-q025', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt1', responseType: 'single_choice',
    content: 'Khi bổ sung các yếu tố vô sinh như nước, đất, ánh sáng vào quần xã sinh vật, ta có cấp tổ chức nào?',
    options: ['A. Quần thể', 'B. Hệ sinh thái', 'C. Cơ thể', 'D. Bào quan'], correctAnswer: 'B',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O06'], competency: 'biological_cognition', cognitiveLevel: 'recognition', estimatedSeconds: 45
  },
  {
    id: 'bio10-m0-q026', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt1', responseType: 'single_choice',
    content: 'Đối tượng nào sau đây KHÔNG phải là một quần thể sinh vật?',
    options: ['A. Các cây thông cùng loài trên một sườn núi', 'B. Các con ốc bươu vàng trong một ruộng lúa', 'C. Cá, tôm, rong và vi khuẩn trong một ao', 'D. Các cá thể voọc cùng loài trong một khu bảo tồn'], correctAnswer: 'C',
  ...
  {
    id: 'bio10-m0-q029', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt1', responseType: 'single_choice',
    content: 'Vì sao không thể dự đoán đầy đủ hoạt động của một cơ thể đa bào chỉ bằng cách liệt kê tính chất của từng tế bào riêng lẻ?',
    options: ['A. Tế bào không có cấu trúc', 'B. Sự tương tác và phân hóa giữa các tế bào tạo ra chức năng nổi trội ở mô, cơ quan và cơ thể', 'C. Cơ thể không được cấu tạo từ tế bào', 'D. Mọi tế bào trong cơ thể đều hoàn toàn giống nhau'], correctAnswer: 'B',
    difficulty: 'hard', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O06'], competency: 'biological_cognition', cognitiveLevel: 'application', estimatedSeconds: 85
  },
  {
  ...
  {
    id: 'bio10-m0-q032', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt9', responseType: 'single_choice',
    content: 'Nghề nào sau đây gắn trực tiếp nhất với việc phát triển vaccine?',
    options: ['A. Nghiên cứu y sinh và công nghệ sinh học', 'B. Kĩ thuật xây dựng cầu', 'C. Thiết kế thời trang', 'D. Khai thác địa chất'], correctAnswer: 'A',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O01', 'BIO10-M0-O02'], competency: 'biological_cognition', cognitiveLevel: 'recognition', estimatedSeconds: 40
  },
  {
  ...
  {
    id: 'bio10-m0-q037', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt9', responseType: 'single_choice',
    content: 'Trước khi giải phóng một giống cây biến đổi gene ra môi trường, đánh giá nào cần thiết nhất?',
    options: ['A. Chỉ đo năng suất trong một vụ', 'B. Đánh giá nguy cơ phát tán gene, tác động sinh vật không mục tiêu, hiệu quả và kế hoạch giám sát dài hạn', 'C. Chỉ hỏi ý kiến nhà sản xuất', 'D. Suy ra an toàn từ màu sắc của hạt'], correctAnswer: 'B',
  ...
  {
    id: 'bio10-m0-q040', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt10', responseType: 'single_choice',
    content: 'Dùng kính hiển vi để mô tả hình dạng tế bào biểu bì hành mà không thay đổi điều kiện của tế bào là phương pháp chủ đạo nào?',
    options: ['A. Quan sát', 'B. Điều tra xã hội học', 'C. Lai tạo', 'D. Mô phỏng khí hậu'], correctAnswer: 'A',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O03'], competency: 'biological_inquiry', cognitiveLevel: 'recognition', estimatedSeconds: 40
  },
  {
  ...
  {
    id: 'bio10-m0-q044', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt10', responseType: 'single_choice',
    content: 'Muốn vừa mô tả hoạt động ban đêm của một loài thú vừa kiểm tra phản ứng của nó với một mùi cụ thể, tổ hợp phương pháp nào hợp lí?',
    options: ['A. Quan sát bằng bẫy ảnh, sau đó thực nghiệm có kiểm soát về mùi', 'B. Chỉ phỏng đoán từ tên loài', 'C. Chỉ điều tra ý kiến người chưa từng quan sát loài', 'D. Thay đổi đồng thời mùi, ánh sáng và thức ăn'], correctAnswer: 'A',
    difficulty: 'medium', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O03'], competency: 'biological_inquiry', cognitiveLevel: 'application', estimatedSeconds: 75
  },
  {
    id: 'bio10-m0-q045', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt10', responseType: 'single_choice',
    content: 'Khi nghiên cứu phản ứng đau ở động vật, lựa chọn nào phù hợp nhất về phương pháp và đạo đức?',
    options: ['A. Dùng số lượng không giới hạn để chắc chắn có kết quả', 'B. Ưu tiên phương pháp thay thế, giảm số lượng, giảm đau và chỉ dùng động vật khi thật cần thiết', 'C. Không cần hội đồng đạo đức', 'D. Gây đau mạnh hơn để dữ liệu rõ hơn'], correctAnswer: 'B',
    difficulty: 'hard', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O02', 'BIO10-M0-O03'], competency: 'biological_inquiry', cognitiveLevel: 'application', estimatedSeconds: 90
  },
  {
  ...
  {
    id: 'bio10-m0-q048', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt11', responseType: 'single_choice',
    content: 'Trong thí nghiệm khảo sát ảnh hưởng của độ mặn đến nhịp co của tim Daphnia, biến độc lập là gì?',
    options: ['A. Độ mặn của môi trường', 'B. Nhịp co tim đo được', 'C. Loài Daphnia', 'D. Thời gian quan sát được giữ cố định'], correctAnswer: 'A',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O04'], competency: 'biological_inquiry', cognitiveLevel: 'recognition', estimatedSeconds: 45
  },
  {
  ...
  {
    id: 'bio10-m0-q053', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt11', responseType: 'single_choice',
    content: 'Muốn kiểm tra đồng thời ảnh hưởng của nhiệt độ và pH tới hoạt tính enzyme, thiết kế nào cho phép phát hiện cả tác động riêng và tương tác?',
    options: ['A. Chỉ dùng một nhiệt độ và một pH', 'B. Phối hợp mọi mức nhiệt độ với mọi mức pH, có lặp lại', 'C. Mỗi mức nhiệt dùng một enzyme khác nhau', 'D. Thay pH nhưng không đo hoạt tính'], correctAnswer: 'B',
  ...
  {
    id: 'bio10-m0-q056', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt12', responseType: 'single_choice',
    stimulus: { id: 'bio10-m0-st056', title: 'Chiều dài rễ', dataTable: { caption: 'Chiều dài rễ trung bình sau 7 ngày', columns: [{ key: 'group', label: 'Nhóm' }, { key: 'length', label: 'Chiều dài', unit: 'mm' }], rows: [{ group: 'Đối chứng', length: 18 }, { group: 'Xử lí X', length: 27 }] } },
    content: 'Trong thí nghiệm này, rễ nhóm xử lí X dài hơn nhóm đối chứng bao nhiêu milimet?',
    options: ['A. 9 mm', 'B. 18 mm', 'C. 27 mm', 'D. 45 mm'], correctAnswer: 'A',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O04'], competency: 'biological_inquiry', cognitiveLevel: 'recognition', estimatedSeconds: 55
  },
  {
    id: 'bio10-m0-q057', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt12', responseType: 'single_choice',
    content: 'Trong một đồ thị, trục hoành là thời gian và trục tung là số tế bào. Đường biểu diễn nằm ngang từ giờ 4 đến giờ 6 cho biết điều gì?',
    options: ['A. Số tế bào giảm liên tục', 'B. Số tế bào không thay đổi trong khoảng đó', 'C. Tốc độ tăng đạt cực đại', 'D. Không thể đọc vì thiếu màu sắc'], correctAnswer: 'B',
    difficulty: 'easy', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O04'], competency: 'biological_inquiry', cognitiveLevel: 'recognition', estimatedSeconds: 50
  },
  {
  ...
  {
    id: 'bio10-m0-q061', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt12', responseType: 'single_choice',
    content: 'Nhóm xử lí có 90% hạt nảy mầm, nhóm đối chứng 60%, nhưng mỗi nhóm chỉ có 10 hạt. Kết luận phù hợp nhất là gì?',
    options: ['A. Xử lí chắc chắn hiệu quả với mọi giống', 'B. Kết quả gợi ý tác động tích cực nhưng cỡ mẫu nhỏ, cần lặp lại với nhiều hạt', 'C. Không cần biết nhóm đối chứng', 'D. Chênh lệch 30 điểm phần trăm đồng nghĩa tăng đúng 30% tương đối'], correctAnswer: 'B',
    difficulty: 'hard', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O04'], competency: 'biological_inquiry', cognitiveLevel: 'application', estimatedSeconds: 90
  },
  {
  ...
  {
    id: 'bio10-m0-q064', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt13', responseType: 'single_choice',
    content: 'Dụng cụ nào phù hợp nhất để chuyển chính xác 100 µL dung dịch?',
    options: ['A. Micropipette', 'B. Thước mét', 'C. Kính lúp', 'D. Nhiệt kế'], correctAnswer: 'A',
  ...
  {
    id: 'bio10-m0-q068', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt13', responseType: 'single_choice',
    content: 'Để quan sát bề mặt ba chiều của hạt phấn với độ phân giải cao, thiết bị phù hợp nhất là gì?',
    options: ['A. Kính hiển vi điện tử quét', 'B. Kính hiển vi điện tử truyền qua', 'C. Cân phân tích', 'D. Máy PCR'], correctAnswer: 'A',
    difficulty: 'medium', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O05'], competency: 'biological_cognition', cognitiveLevel: 'application', estimatedSeconds: 65
  },
  {
  ...
  {
    id: 'bio10-m0-q070', subjectId: 'biology', topicId: 'bio10-t0', questionTypeId: 'bio10-qt13', responseType: 'single_choice',
    content: 'Ảnh hiển vi có thanh tỉ lệ 10 µm dài 2 cm trên màn hình. Một tế bào dài 5 cm trên cùng ảnh có chiều dài thực là bao nhiêu?',
    options: ['A. 4 µm', 'B. 10 µm', 'C. 25 µm', 'D. 50 µm'], correctAnswer: 'C',
    difficulty: 'hard', sourceType: 'manual', validatorType: 'choice', outcomeIds: ['BIO10-M0-O05'], competency: 'biological_inquiry', cognitiveLevel: 'application', estimatedSeconds: 90
  },
  {
